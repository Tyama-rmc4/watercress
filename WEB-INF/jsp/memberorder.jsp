...
<script src="${pageContext.request.contextPath}/js/inputDestruction.js" charset="UTF-8"></script>
<script src="${pageContext.request.contextPath}/js/memberorder.js" charset="UTF-8"></script>
...
<br><br><br>
	<form class="h-adr" action="ordercheck" method="post">
		...
		都道府県　<input name="prefectures" value="${data.addr1}" type="text" id="address_1" class="p-region" autocomplete="address-level1" readonly />&nbsp;&nbsp;例：東京都<br>
		市区町村　<input name="city" value="${data.addr2}" type="text" id="address_2" class="p-locality" autocomplete="address-level2" />&nbsp;&nbsp;中野区<br>
		番地　　　　<input name="blocknumber" value="${data.addr3}" type="text" id="address_3" class="p-street-address" autocomplete="address-line1" />&nbsp;&nbsp;東中野4-2-3<br>
		建物名　　 <input name="bildingname" value="${data.addr4}" type="text" id="address_4" class="p-extended-address" autocomplete="address-line2" />&nbsp;&nbsp;専門学校 東京テクニカルカレッジ<br><br>

		電話番号<input type="text" name="phonenumber" value="${data.phonenumber}" required><p class="req" pattern="^[0-9]">※必須</p><nobr>半角数字のみ。ハイフン(-)は入れない。<nobr>例：09012345678<br><br><br>
		<h3>配達時間指定</h3>
...
<input type="radio" name="delivery_request_time" value="20時～21時">20時～21時
<br>
...
<h3>お支払方法の選択&nbsp;</h3><p class="req">※必須</p><nobr>
	...
	カード番号<input class="card" id="card_0" type="text" name="creditcardnumber" >
	セキュリティコード<input class="card" id="card_1" type="text" name="securitycode" >
	年<input class="card" id="card_2" type="text" name="expirationdate_year" >
	月<input class="card" id="card_3" type="text" name="expirationdate_month" ><br>半角数字のみ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;例：1234123412341234
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
年/月 例：20/10<br><br>
	...
	<input id="hiddentotalprice" type="hidden" value="${data.orderprice}" name="totalprice">
