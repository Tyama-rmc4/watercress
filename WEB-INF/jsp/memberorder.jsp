        ...
        <body>
            ...
            <form class="h-adr" action="ordercheck" method="post">
                ...
                性<input class="name" type="text" name="firstname" value="${data.firstname}" required><p class="req">※必須</p><nobr>
                    ...
                    名<input class="name" type="text" name="name" value="${data.name}" required><p class="req">※必須</p><nobr>
                        &nbsp;&nbsp;例：山田&nbsp;太郎
                        <br><br>
                        セイ<input class="name" type="text" name="kanafirstname" value="${data.kanafirstname}" required pattern="^[ァ-ンヴー]+$*"><p class="req">※必須</p><nobr>
                            メイ<input class="name" type="text" name="kananame" value="${data.kananame}" required pattern="^[ァ-ンヴー]+$"><p class="req">※必須</p><nobr>
                                &nbsp;&nbsp;例：ヤマダ&nbsp;タロウ
                                <br><br>
                                ...
                                〒郵便番号<input type="text" id="address_0" class="p-postal-code" size="7" maxlength="7" name="zipcode" autocomplete="postal-code"  value="${data.addr0}" disabled>&nbsp;&nbsp;例：1648787<br><br>
                                ...
                                電話番号<input type="text" name="phonenumber" value="${data.phonenumber}" required><p class="req" pattern="^[0-9]">※必須</p><nobr>
                                        ...
                                        配達希望日&nbsp;<p class="req">※必須</p><nobr>
                                            ...
                                            配達希望時間&nbsp;<p class="req">※必須</p><nobr>
                                                ...
                                                <h3>お支払方法の選択&nbsp;</h3><p class="req">※必須</p><nobr>
                                                    ...
                                                    月<input class="card" id="card_3" type="text" name="expirationdate_month" disabled="true">
                                                    <br>
                                                    半角数字のみ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    例：1234123412341234
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
