...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath}/js/abc.css" rel="stylesheet" type="text/css"/>
		
	</head>
	<body >
		<a href="usercheck.html" >登録情報確認ペーげ</a>
		
		<form id="registform" class="h-adr" action="signup" method="post">
