...
<script src="${pageContext.request.contextPath}https://yubinbango.github.io/yubinbango/yubinbango.js" charset="UTF-8"></script>
...
<br>
	<p>登録画面</p>
		<form id="registform" class="h-adr" action="${pageContext.request.contextPath}/front/entrycheck" method="post">
		    ...
		    市区<input type="text" name="municipality" class="p-locality"  /><br>
		    町村<input type="text" name="address" class="p-street-address" /><br>
		    ビル名<input type="text" name="buildingName" class="p-extended-address" />
			<br><br>
