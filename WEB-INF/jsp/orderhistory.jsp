...
<li class="arrow"><a>CATEGORY</a>
    ...
    <li><a href="${pageContext.request.contextPath}/front/list2">BOTTOMS</a></li>
    <li><a href="${pageContext.request.contextPath}/front/list3">UNDER</a></li>
    <li><a href="${pageContext.request.contextPath}/front/list4">SHOES</a></li>
    <li><a href="${pageContext.request.contextPath}/front/list5">ACCESSORIES</a></li>
	</ul>
</li>
