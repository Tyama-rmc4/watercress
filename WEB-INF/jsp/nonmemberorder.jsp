        ...
        <body>
            ...
            <form class="h-adr" action="ordercheck" method="post">
                ...
                性<input class="name" type="text" name="firstname" required><p class="req">※必須</p><nobr>
                    ...
                    名<input class="name" type="text" name="name" required><p class="req">※必須</p><nobr>
                        &nbsp;&nbsp;例：山田&nbsp;太郎
                        <br><br>
                        セイ<input class="name" type="text" name="kanafirstname" required pattern="^[ァ-ンヴー]+$*"><p class="req">※必須</p><nobr>
                            メイ<input class="name" type="text" name="kananame" required pattern="^[ァ-ンヴー]+$"><p class="req">※必須</p><nobr>
                                &nbsp;&nbsp;例：ヤマダ&nbsp;タロウ
                                <br><br>
                                ...
                                電話番号<input type="text" name="phonenumber" required><p class="req" pattern="^[0-9]">※必須</p><nobr>
